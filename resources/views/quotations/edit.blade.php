...
<div class="container-fluid px-0">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
        <div>
            <h4 class="text-dark fw-bold mb-1">Edit Quotation</h4>
            <p class="text-muted small mb-0">Modifying document details for quotation number: <span class="fw-semibold text-dark font-monospace">{{ $quotation->quotation_no }}</span></p>
        </div>
                ...
                <div class="card border-0 shadow-sm rounded-4 sticky-lg-top" style="top: 90px; z-index: 1020;">
                    <div class="card-header bg-transparent border-0 pt-4 px-4 pb-0">
                        <div class="d-flex align-items-center">
                            <div class="p-2 bg-success bg-opacity-10 text-success rounded-3 me-3 d-flex align-items-center justify-content-center" style="width: 36px; height: 36px;">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-grid">
                            <button type="submit" class="btn text-white btn-lg rounded-3 shadow-sm py-2.5 btn-update-trigger" style="background: var(--accent-brown); border: 0; font-weight: 600; font-size: 1rem;">
                                <i class="bi bi-pencil-square me-2"></i> Update Quotation
                            </button>
                        </div>
                    </div>
                </div>
