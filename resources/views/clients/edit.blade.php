...
<div class="container-fluid px-0" style="max-width: 900px; margin: 0 auto;">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
        <div>
            <h4 class="text-dark fw-bold mb-1">Modify Client Profile</h4>
            <p class="text-muted small mb-0">Update information details for <span class="fw-semibold text-dark">{{ $client->company_name }}</span> below.</p>
        </div>
    ...
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
        ...
        <div class="card-header bg-transparent border-0 pt-4 px-4 pb-0">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h5 class="mb-0 fw-bold text-dark">Edit Client Records</h5>
                    <p class="text-muted small mb-0">Review or adjust saved contact details and company settings</p>
                </div>
            </div>
        </div>
